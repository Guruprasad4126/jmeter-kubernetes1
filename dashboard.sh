...
kubectl exec -i -n $tenant $grafana_pod -- curl 'http://admin:admin@internal-acdefda6ab02d406baa30bd3e44587dd-136511828.us-east-2.elb.amazonaws.com :3000/api/datasources' -X POST -H 'Content-Type: application/json;charset=UTF-8' --data-binary '{"name":"jmeterdb","type":"influxdb","url":"http://jmeter-influxdb:8086","access":"proxy","isDefault":true,"database":"jmeter","user":"guru","password":"admin"}'
